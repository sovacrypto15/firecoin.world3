...
window.App = {
    start: function () {
        ...
        web3.eth.getAccounts(function (err, accs) {
            if (err != null) {
                alert("There was an error fetching your accounts! Open Metamask or Mist wallet.");
                return;
            }

            if (accs.length == 0) {
                alert("Couldn't get any accounts! Open Metamask or Mist wallet.");
                return;
            }
    ...
    printImportantInformation: function () {
        ExchangeContract.deployed().then(function (instance) {
            ...
            divAddress.appendChild(document.createTextNode("Fire-Exchange Address: " + instance.address));
        ...
        TokenContract.deployed().then(function (instance) {
            var divAddress = document.createElement("div");
            divAddress.appendChild(document.createTextNode("Firecoin Address: " + instance.address));
            divAddress.setAttribute("class", "alert alert-info");
            document.getElementById("importantInformation").appendChild(divAddress);
        });
    ...
    refreshBalanceExchange: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            return exchangeInstance.getBalance("FRCN", {from: account});
        }).then(function (value) {
            ...
            var balance_element = document.getElementById("balanceWeiInExchange");
            balance_element.innerHTML = web3.fromWei(value, "Wei");
        }).catch(function (e) {
            console.log(e);
    ...
    updateOrderBooks: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            exchangeInstance = instance;
            return exchangeInstance.getSellOrderBook("FRCN");
            ...
            return exchangeInstance.getBuyOrderBook("FRCN");
